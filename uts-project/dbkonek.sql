...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 15 Bulan Mei 2023 pada 18.29
...
(10, '2023-05-14', 'Budi', 'Depok', '08122189248', 'test@example.com', 200, 'test', 1),
(11, '2023-05-14', 'Radit', 'Komplek Mutiara', '085882846665', 'dit144@gmail.com', 10, 'Beda Beda Warna', 1);
...
(1, 'HD1', 'HOODIE', 180000, 100000, 199, 5, 'Hoodie Hitam', 1),
(2, 'KS01', 'Kaos Hitam Polos', 150000, 100000, 100, 2, 'Kaos Hitam dengan motif polos', 2),
(5, 'CL01', 'Celana Jeans', 160000, 100000, 90, 10, 'Celana Jeans Panjang', 3);
...
ALTER TABLE `pesanan`
  ...
  ADD KEY `kode_UNIQUE` (`tanggal`) USING BTREE;
...
ALTER TABLE `produk`
  ...
  ADD KEY `fk_produk_kategori_produk_idx` (`kategori_produk_id`) USING BTREE;
